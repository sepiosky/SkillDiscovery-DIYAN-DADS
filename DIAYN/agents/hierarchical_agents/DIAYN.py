...
class DIAYN(Base_Agent):
    ...
    def __init__(self, config):
        ...
        self.agent_config.environment = config.environment # Ant-v2
        ...
        self.manager_agent_config.environment = config.environment # Ant-v2
    ...
    def get_predicted_probability_of_skill(self, skill, next_state):
        ...
        # why isn't this softmax applied before the discriminator's output?
...
class DIAYN_Skill_Wrapper(Wrapper):
    ...
    def observation(self, observation):
        # returns skill as a part of the observation
    ...
    def calculate_new_reward(self, next_state):
        """Calculates an intrinsic reward that encourages maximum exploration. 
        It also keeps track of the discriminator
...
class DIAYN_Manager_Agent_Wrapper(Wrapper):
    ...
    def step(self, skill_chosen):
        """Runs a step in the game from the perspective of the manager agent. 
        This involves giving up control to the
